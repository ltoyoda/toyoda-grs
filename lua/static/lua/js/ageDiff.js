...
function HSum(form) {
  var difference;
  difference = myLat - myLon;
  form.Fdiff.value = difference;
  form.FLat2.value = myLat;
  form.FLon2.value = myLon;
}
...
//  document.write("Book title is : " + nameValue);
//****************************************************************************************
var map = null;
//var ourCoords =  {      // for calculating the distance to CITG-DELFT
//	latitude: 51.999033,
...
// Displays local position
	div.innerHTML = "Study area at Latitude: " + latitude2 + ", Longitude: " + longitude2;
...
// and displays the distance
	distance.innerHTML = "It is " + km + " km away from your current location";
